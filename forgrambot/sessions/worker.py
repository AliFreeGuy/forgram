        ...
        if user.exists():
            ...
            if user_sessions :
                ...
                try :
                        ...
                        if msg.empty != True :
                                ...
                                if msg.chat.has_protected_content :
                                        if media == 'None' : 
                                                ...
                                                edit_message(chat_id=user_id , message_id=message_id , text = 'âœ… Ø¨Ø§ Ù…ÙˆÙ�Ù‚ÛŒØª Ø§Ù†Ø¬Ø§Ù… Ø´Ø¯ ')
                                                ...
                                                if int(volume)  > file_size : 
                                                        ...
                                                        link_data.is_complete = True
                                                        link_data.save()
                                                else :send_message(chat_id=user_id , text = 'Ø­Ø¬Ù… Ø¯Ø§Ù†Ù„ÙˆØ¯ Ø´Ù…Ø§ Ù†Ø§Ú©Ø§Ù�ÛŒ Ø§Ø³Øª Ø¨Ø±Ø§ÛŒ Ø§Ù�Ø²Ø§ÛŒØ´ Ø­Ø¬Ù… Ø§Ø´ØªØ±Ø§Ú© ØªÙ‡ÛŒÙ‡ Ú©Ù†ÛŒØ¯')
                        ...
                        print(e)
                        send_message(chat_id=user_id , text = 'Ø­Ø³Ø§Ø¨ Ø´Ù…Ø§ Ø¨Ù‡ Ø±Ø¨Ø§Øª Ù…ØªØµÙ„ Ù†ÛŒØ³Øª Ù„Ø·Ù�Ø§ Ø§Ø² Ø·Ø±ÛŒÙ‚ Ø¯Ú©Ù…Ù‡ Ø§ØªØµØ§Ù„ Ø§Ù‚Ø¯Ø§Ù… Ú©Ù†ÛŒØ¯')
                        try :
                                client.disconnect()
                        except :pass
